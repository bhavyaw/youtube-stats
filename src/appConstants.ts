export const APP_CONSTANTS: any = {
  ...
  DAY_IN_MS: 86400000,
  ACTIVITY_CONTROLS_PAGE_NEW_TITLE: 'Activity controls YH_CE',
  MY_ACTIVITY_PAGE_NEW_TITLE: 'Google - My Activity YH_CE',
  ACTIVITY_CONTROLS_PAGE_URL: 'https://myaccount.google.com/activitycontrols',
  MY_ACTIVITY_PAGE_URL: 'https://myactivity.google.com/item?restrict=ytw&hl=en-GB',
  EXTENSION_URL_HASH: 'yhce'
};

export const DATA_FETCHING_URLS = {
  CONTINUATION_OLD_0: '/item?restrict=ytw&hl=en-GB&jspb=1',
  CONTINUATION: '_/FootprintsMyactivityUi/data/batchexecute',
